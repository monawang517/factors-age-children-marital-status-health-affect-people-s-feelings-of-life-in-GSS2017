...
#Code and data supporting this analysis are available at: https://github.com/monawang517/factors-age-children-marital-status-health-affect-people-s-feelings-of-life-in-GSS2017
...
```{r, echo =FALSE, message=FALSE, warning = FALSE}
library(tidyverse)
ggplot(data, aes(age, feelings_life, color = feelings_life)) + geom_point() + labs(title = "Figure 4:age vs feelings_of_life")
...
```{r, echo =FALSE, message=FALSE, warning = FALSE}
library(tidyverse)
plot(feelings_life ~ as.factor(total_children), data = data, main = "Figure 5: total_children vs Feelings of life", xlab = "total_children")
...
```{r, echo =FALSE, message=FALSE, warning = FALSE}
library(tidyverse)
ggplot(data, aes(age_first_child, feelings_life, color=feelings_life)) + geom_point() + labs(title = "Figure 6: age of first child vs feelings of life")
...
```{r, echo =FALSE, message=FALSE, warning = FALSE}
library(tidyverse)
ggplot(data, aes(age, feelings_life, color = feelings_life)) + geom_point() + labs(title = "Figure 4")
plot(feelings_life ~ as.factor(total_children), data = data, main = "Figure 5", xlab = "total_children")
ggplot(data, aes(age_first_child, feelings_life, color=feelings_life)) + geom_point() + labs(title = "Figure 6")
ggplot(data=data1, aes(y =`feelings_life`))+geom_bar() + geom_bar(aes(fill = `marital_status`)) + labs(title="Figure 7")
plot(feelings_life ~ as.factor(self_rated_health), data = data, main = "Figure 8", xlab = "self_rated_health")
plot(feelings_life ~ as.factor(self_rated_mental_health), data = data, main = "Figure 9", xlab = "self_rated_mental_health")
```
